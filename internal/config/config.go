...
type Config struct {
	...
	DatabaseDSN  string        `env:"AVIAPI_DATABASE_DSN" env-default:"postgres://postgres:postgres@localhost:5432/aviapi_db?sslmode=disable"` //nolint:lll
	ReadTimeout  time.Duration `env:"AVIAPI_READ_TIMEOUT" env-default:"5s"`
